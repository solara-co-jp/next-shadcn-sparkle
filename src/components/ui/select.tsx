...
/* ─── Sparkle Select (high-level) ─── */

const sparkleSizeStyles: Record<SparkleSize, string> = {
          ...
          render={
            <span
              className={cn(
                ...
                "text-sp-text-low pointer-events-none shrink-0"
              )}
      ...
      >
        {options.map((option) => (
          <SelectPrimitive.Item
            ...
            data-slot="select-item"
            className={cn(
              "relative flex w-full cursor-pointer items-center gap-1.5 rounded-md py-[var(--sp-8)] pr-8 pl-[var(--sp-12)]",
              "text-sp-text-high",
              "text-[length:var(--font-size-sp-2)] leading-[var(--lh-2)]",
              "font-[family-name:var(--font-family-base)]",
              "outline-hidden select-none",
              "focus:bg-sp-neutral-50",
            ...
            >
              <span
                className={cn(
                  "font-[family-name:var(--font-family-icon)]",
                  "leading-none select-none inline-flex items-center justify-center",
                  "text-sp-text-high pointer-events-none"
                )}
                style={{ fontSize: "20px", width: "20px", height: "20px" }}
                aria-hidden="true"
              >

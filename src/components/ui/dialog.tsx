...
const sizeMap: Record<ModalSize, string> = {
  sm: "max-w-[400px]",
  md: "max-w-[560px]",
  lg: "max-w-[var(--max-width-sp-lg)]",
  xl: "max-w-[960px]",
  full: "max-w-[calc(100vw-var(--sp-64))]",
};
      ...
      >
        ...
        <DialogHeader
          className={cn(
            ...
            "px-[var(--sp-24)] pt-[var(--sp-16)] pb-0"
          )}
        >
          <DialogTitle
            className={cn(
        ...
        {/* Body */}
        <div className="px-[var(--sp-24)] py-[var(--sp-8)] overflow-auto">
          {children}
        </div>
